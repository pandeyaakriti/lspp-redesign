    ...
    <section id="resources" className="bg-white text-slate-900 py-24 px-6">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[22rem]">
          ...
          {/* Card 1: Event & Insights Videos*/}
          <div className="md:col-span-7 bg-slate-50 border border-slate-100 rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative group hover:shadow-md transition-all duration-300">
            <div className="max-w-sm z-10">
              <h3 className="text-2xl font-sans font-bold text-slate-900 tracking-tight mb-2">{resourcesData[0].title}</h3>
              <p className="text-slate-500 text-sm font-medium leading-relaxed mb-4">{resourcesData[0].description}</p>
              <a href={resourcesData[0].link} className="inline-flex items-center gap-1 text-sm font-bold text-leapfrog-green hover:gap-2 transition-all">
          ...
          {/* Card 2: Workshops  */}
          <div className="md:col-span-5 bg-slate-50 border border-slate-100 rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative group hover:shadow-md transition-all duration-300">
            <div className="z-10">
              <h3 className="text-2xl font-sans font-bold text-slate-900 tracking-tight mb-2">{resourcesData[1].title}</h3>
              <p className="text-slate-500 text-sm font-medium leading-relaxed mb-4">{resourcesData[1].description}</p>
              <a href={resourcesData[1].link} className="inline-flex items-center gap-1 text-sm font-bold text-leapfrog-green hover:gap-2 transition-all">
          ...
          {/* Card 3: Projects by Partners  */}
          <div className="md:col-span-5 bg-slate-50 border border-slate-100 rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative group hover:shadow-md transition-all duration-300">
            <div className="z-10">
             
              <h3 className="text-2xl font-sans font-bold text-slate-900 tracking-tight mb-2">{resourcesData[2].title}</h3>
              <p className="text-slate-500 text-sm font-medium leading-relaxed mb-4">{resourcesData[2].description}</p>
              <a href={resourcesData[2].link} className="inline-flex items-center gap-1 text-sm font-bold text-leapfrog-green hover:gap-2 transition-all">
          ...
          {/* Card 4: Look at the Byte Side */}
          <div className="md:col-span-7 bg-slate-50 border border-slate-100 rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative group hover:shadow-md transition-all duration-300">
            <div className="max-w-sm z-10">
              <h3 className="text-2xl font-sans font-bold text-slate-900 tracking-tight mb-2">{resourcesData[3].title}</h3>
              <p className="text-slate-500 text-sm font-medium leading-relaxed mb-4">{resourcesData[3].description}</p>
              <a href={resourcesData[3].link} className="inline-flex items-center gap-1 text-sm font-bold text-leapfrog-green hover:gap-2 transition-all">
